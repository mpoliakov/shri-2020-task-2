...
var _TEST = _interopRequireDefault(require("./rules/TEST.SEVERAL_H1"));
...
var _default = configuration = {
  WARNING: {},
  TEXT: {
    SEVERAL_H1: _TEST["default"] // INVALID_H2_POSITION: ,
    // INVALID_H3_POSITION:
...
},{"./rules/TEST.SEVERAL_H1":6}],3:[function(require,module,exports){
"use strict";
...
function () {
  function LinterRule() {
    _classCallCheck(this, LinterRule);
  }

  _createClass(LinterRule, [{
    key: "trigger",
    value: function trigger(node) {}
  }, {
    key: "lint",
    value: function lint() {}
  }]);
...
var _linterStrategy = null;

var LinterStrategy =
/*#__PURE__*/
function () {
  function LinterStrategy(configuration) {
    _classCallCheck(this, LinterStrategy);

    if (_linterStrategy) return _linterStrategy;
    ...
    for (var category in configuration) {
      ...
      for (var code in codes) {
        var Rule = codes[code];
        this._rules = [].concat(_toConsumableArray(rules), [new Rule()]);
      }
    }
  }

  _createClass(LinterStrategy, [{
    key: "addStrategy",
    value: function addStrategy(strategy) {
      this._strategies = [].concat(_toConsumableArray(this._strategies), [strategy]);
    }
  }, {
    key: "getStrategy",
    value: function getStrategy(name) {
      return this._strategies.find(function (strategy) {
...
exports["default"] = LinterStrategy;
...
var _linterStrategy = _interopRequireDefault(require("./linter-strategy"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

var lint = function lint(json) {
  var strategy = new _linterStrategy["default"](_configuration["default"]);
  var ast = (0, _jsonToAst["default"])(json);
  traverse(ast);
  return [];
};

var traverse = function traverse(ast) {// https://medium.com/quick-code/data-structures-traversing-trees-9473f6d9f4ef
  // https://blog.bitsrc.io/a-guide-to-javascript-algorithms-search-4d653be3dca2
  // https://www.npmjs.com/package/ast-traverse
};

},{"./configuration":2,"./linter-strategy":4,"json-to-ast":1}],6:[function(require,module,exports){
"use strict";
...
var _linterRule = _interopRequireDefault(require("../linter-rule"));
...
var SeveralH1_Rule =
/*#__PURE__*/
function (_LinterRule) {
  _inherits(SeveralH1_Rule, _LinterRule);

  function SeveralH1_Rule() {
    _classCallCheck(this, SeveralH1_Rule);

    return _possibleConstructorReturn(this, _getPrototypeOf(SeveralH1_Rule).call(this));
  }

  return SeveralH1_Rule;
}(_linterRule["default"]);

exports["default"] = SeveralH1_Rule;
